...
def get_train_test_loaders(batch_size=32):
    trainset = SignLanguageMNIST(r'C:\Users\Luis\Desktop\ModeloSenias\sign-language-translator\data\sign_mnist_train.csv')
    trainloader = torch.utils.data.DataLoader(trainset, batch_size=batch_size, shuffle=True)

    testset = SignLanguageMNIST(r'C:\Users\Luis\Desktop\ModeloSenias\sign-language-translator\data\sign_mnist_test.csv')
